...
export default function Contact() {
  ...
  // Map configuration
  const mapCenter = [36.7538, 3.0588] // Alger coordinates
  const mapMarkers = [
    {
      position: [36.7538, 3.0588],
      popup: `
        <div class="p-3">
          <h3 class="font-bold text-lg text-primary-600 mb-2">🏥 Dawini - Centre Médical</h3>
          <p class="text-sm text-gray-600 mb-2">📍 Alger, Algérie</p>
          <p class="text-xs text-gray-500">Centre médical moderne au cœur d'Alger</p>
          <div class="mt-2 flex space-x-2">
            <a href="tel:+213XXXXXXXXX" class="px-2 py-1 bg-primary-600 text-white text-xs rounded hover:bg-primary-700">
              📞 Appeler
            </a>
            <a href="mailto:dawini_contact@gmail.com" class="px-2 py-1 bg-green-600 text-white text-xs rounded hover:bg-green-700">
              ✉️ Email
            </a>
          </div>
        </div>
