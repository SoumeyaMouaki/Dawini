...
import DoctorPrescriptionsList from '../components/DoctorPrescriptionsList.jsx'
import DoctorSettings from '../components/DoctorSettings.jsx'
import PrescriptionSender from '../components/PrescriptionSender.jsx'
...
export default function DoctorDashboard() {
  ...
  const [isPrescriptionSenderOpen, setIsPrescriptionSenderOpen] = useState(false)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-primary-100 text-xl font-medium">{user.specialization || 'Médecin'}</p>
                <div className="flex items-center text-primary-200 mt-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Cards */}
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                    <p className="text-blue-100 text-sm font-medium">Rendez-vous</p>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-bold">Rechercher patient</div>
                    <div className="text-sm opacity-80">Trouver un patient</div>
                  </div>
                </button>
                
                <button 
                  onClick={() => setIsPrescriptionSenderOpen(true)}
                  className="w-full bg-gradient-to-r from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 text-green-800 font-bold px-6 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 flex items-center justify-center"
                >
                  <FileText className="w-5 h-5 mr-3" />
                  <div className="text-left">
                    <div className="font-bold">Nouvelle ordonnance</div>
                    <div className="text-sm opacity-80">Prescrire et envoyer</div>
                  </div>
                </button>
                
                <button 
                  onClick={() => setActiveTab('prescriptions')}
                  className="w-full bg-gradient-to-r from-teal-100 to-teal-200 hover:from-teal-200 hover:to-teal-300 text-teal-800 font-bold px-6 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 flex items-center justify-center"
                >
                  <FileText className="w-5 h-5 mr-3" />
                  <div className="text-left">
                    <div className="font-bold">Mes ordonnances</div>
                    <div className="text-sm opacity-80">Voir l'historique</div>
                  </div>
                </button>
                
                <button 
                  onClick={() => setActiveTab('messages')}
                  className="w-full bg-gradient-to-r from-purple-100 to-purple-200 hover:from-purple-200 hover:to-purple-300 text-purple-800 font-bold px-6 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 flex items-center justify-center relative"
                >
                  <div className="flex items-center">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm opacity-80">Configurer le profil</div>
                  </div>
                </button>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <DoctorPrescriptionsList 
              prescriptions={[]}
              onStatusChange={(id, status) => console.log('Prescription status changed:', id, status)}
            />
          </div>
        ) : activeTab === 'settings' ? (
          /* Settings Tab */
      ...
      {/* Prescription Sender Modal */}
      <PrescriptionSender
        isOpen={isPrescriptionSenderOpen}
        onClose={() => setIsPrescriptionSenderOpen(false)}
        doctorId={doctorProfileId}
        onPrescriptionSent={(prescription) => {
          console.log('Prescription sent successfully:', prescription)
          // Here you would typically update the prescriptions list
          // and send notifications to patient and pharmacy
        }}
      />
    </div>
  )
